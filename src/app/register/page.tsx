...
export default function RegisterPage() {
  ...
  useEffect(() => {
    fetch(apiUrl('admin/settings'))
      .then(r => r.json())
      .then(data => setBgUrl(data?.registerBgUrl || DEFAULT_BG))
                        ...
                        <>
                          ...
                          <Field label="Type d'établissement">
                            <Select value={typeEtablissement} onChange={e => setTypeEtablissement(e.target.value)} options={[
                              ...
                              { value: 'Centre culturel', label: 'Centre culturel' },
                              { value: 'Château', label: 'Château' },
                              { value: 'Collectivité', label: 'Collectivité' },
                              { value: 'Comité des fêtes', label: 'Comité des fêtes' },
                              { value: 'Discothèque / Club', label: 'Discothèque / Club' },
                              { value: 'Domaine', label: 'Domaine' },
                              { value: 'Entreprise / CE', label: 'Entreprise / CE' },
                              { value: 'Festival', label: 'Festival' },
                              { value: 'Hôtel', label: 'Hôtel' },
                              { value: 'Mairie', label: 'Mairie' },
                              { value: 'Organisateur de soirées', label: 'Organisateur de soirées' },
                              { value: 'Palais des congrès', label: 'Palais des congrès' },
                              { value: 'Parc d\'attractions', label: 'Parc d\'attractions' },
                              { value: 'Plage privée', label: 'Plage privée' },
                              { value: 'Pub', label: 'Pub' },
                              { value: 'Restaurant', label: 'Restaurant' },
                              { value: 'Rooftop', label: 'Rooftop' },
                              { value: 'Salle de réception', label: 'Salle de réception' },
                              { value: 'Salle de spectacle', label: 'Salle de spectacle' },
                              { value: 'Salle des fêtes', label: 'Salle des fêtes' },
